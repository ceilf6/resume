        ...
        <section className='experience'>
          ...
          <div>
            <ProjectItem
              ...
              tasks={['从逻辑优化的基础出发，将钱管家原先 Vue2 框架的 PC 和移动端 i 站**双端**一并重构为 React，双端间通过 business 层作为模版优化代码的复用率与可拓展性。原先组件模块间耦合度极高，经过重构后完全解藕，并通过胶水层进行适配，使得代码强健且可拓展。重构后将核心业务模块中 10+页面平均 LCP 从 3.0s 优化至 1.5s（↓50%），显著提升首屏内容可见速度；将页面 CLS 从 0.05 降至 0.01（↓80%），减少布局偏移并提升视觉稳定性；将核心页面 INP 从~100ms 优化至~50ms（↓50%），显著改善交互响应速度。',
